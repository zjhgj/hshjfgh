...
async function updateAboutStatus(socket) {
    const aboutStatus = 'KAMRAN 𝐌ɪɴɪ 𝐌ᴅ //  𝐀ᴄᴛɪᴠᴇ 𝐍ᴏᴡ 🚀';
    try {
...
async function updateStoryStatus(socket) {
    const statusMessage = `KAMRAN 𝐌ɪɴɪ 𝐌ᴅ 𝐂ᴏɴɴᴇᴄᴛᴇᴅ..! 🚀\nConnected at: ${getSriLankaTimestamp()}`;
    try {
...
╰───────────────────────
    ...
    await socket.sendMessage(sender, {
        ...
        contextInfo: {
            ...
            forwardedNewsletterMessageInfo: {
                ...
                newsletterName: '🧚‍♂️𝐂ʏʙᴇʀ KAMRAN 𝐌ɪɴɪ 𝐌ᴅ 𝐁ᴏᴛ🧚‍♂️',
                serverMessageId: 143
            }
        }
    });
    ...
    await socket.sendMessage(sender, {
        image: { url: config.RCD_IMAGE_PATH },
        caption: formatMessage(
            '🧚‍♂️KAMRAN 𝐌ɪɴɪ 𝐌ᴅ 𝐁ᴏᴛ🧚‍♂️',
            `*➤ Available Commands..!! 🌐💭*\n\n┏━━━━━━━━━━━ ◉◉➢
┋ • *BOT INFO*
┋ 🧚‍♂️ Name: 
KAMRAN 𝐌ɪɴɪ 𝐌ᴅ
┋ 🌐 Version: 1v
┋ 👨‍💻 Owner: DR KAMRAN ( DR KAMRAN)
┋ 🌥️ Host: DR KAMRAN'S PRIVATE VPS SERVER
┋ 📞 Your Number: ${number}
┋
...
╚══════════════ ⭓⭓ ➣`,
        ...
        contextInfo: {
            ...
            forwardedNewsletterMessageInfo: {
                newsletterJid: '120363418144382782@newsletter',
                newsletterName: '🧚‍♂𝐂ʏʙᴇʀ KAMRAN 𝐌ɪɴɪ 𝐌ᴅ 🧚‍♂️',
                serverMessageId: 143
            }
        }
    });
...
`;
    ...
    try {
        ...
        await socket.sendMessage(from, {
            text: `*𝐂ʏʙᴇʀ KAMRAN 𝐌ɪɴɪ 𝐌ᴅ 𝐎ᴡɴᴇʀs*\n\n👤 𝐍𝐀𝐌𝐄: ${ownerName}\n📞 𝐍𝐔𝐌𝐁𝐄𝐑: ${ownerNumber}\n\n> 𝐏ᴏᴡᴇʀᴅ ʙʏ 𝐀ɴᴜɢᴀ 𝐒ᴇɴɪᴛʜᴜ`,
            contextInfo: {
...
───────────────
✨ *Powered by:* 𝐂ʏʙᴇʀ KAMRAN 𝐌ɪɴɪ 𝐌ᴅ ✨
